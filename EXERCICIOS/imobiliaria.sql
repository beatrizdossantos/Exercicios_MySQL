...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 08-Set-2019 às 13:17
...
CREATE TABLE IF NOT EXISTS `aluguel` (
  ...
  KEY `codimovel` (`codimovel`),
  KEY `codinquilino` (`codinquilino`),
  KEY `codcorretor` (`codcorretor`)
...
(1, 'Rua A', '111', 'Vila Delphi', 'Casa 1', 'Suzano', 'SP', '09876-666', '1095.12', 3, 4, 2, b'1', b'1', b'1', b'0'),
(2, 'Rua B', '222', 'Vila Nova', 'Fundos', 'Ribeirão Pires', 'SP', '09666-444', '1368.90', 1, 6, 2, b'1', b'1', b'1', b'0'),
(3, 'Rua C', '333', 'Jd. Clara', 'Casa 2', 'Mauá', 'SP', '09777-333', '684.45', 2, 2, 1, b'0', b'1', b'1', b'0'),
(4, 'Rua F', '444', 'Jd. Novo', NULL, 'Mauá', 'SP', '98989-777', '958.23', 1, 4, 1, b'0', b'1', b'0', b'1'),
...
INSERT INTO `inquilino` (`codinquilino`, `nomeinquilino`, `rginquilino`, `emailinquilino`, `telcel`, `telfixo`, `datanasc`, `salario`) VALUES
('INQ123', 'Carlos Fernando', '55.555.555-x', 'carlos@gmail.com', '92222-2222', '7777-8888', '1982-12-21', '1200.00'),
('INQ124', 'José Augusto', '44.666.777-x', 'jose@gmail.com', '98888-3333', '1111-1111', '1974-02-14', '4500.00'),
('INQ125', 'Carla Eduarda', '88.999.999-a', 'carla@hotmail.com', '96666-7777', '2222-3333', '1960-06-02', '1700.00'),
('INQ155', 'Patrícia Reis', '15.689.475-1', 'patre@gmail.com', '998756412', '48237785', '1980-10-10', '3000.00');
...
CREATE TABLE IF NOT EXISTS `proprietario` (
  `codprop` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 'Mauro Trindade', 'mauro@gmail.com', '(11)93333-3333', '(+55)(11)4444-5'),
(2, 'Arthur Trindade', 'jose@gmail.com', '(11)96666-6666', '(+55)(11)1111-5'),
(3, 'Cíntia Pinho', 'cintia@hotmail.com', '(11)98888-4444', '(+55)(11)3333-3'),
(4, 'Casemiro Nogueira', 'casemiro@gmail.com', '(11)88888-5555', '(+55)(11)5599-8');
